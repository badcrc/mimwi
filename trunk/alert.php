...
if($event_id!="") {
	...
	$query="SELECT event_id,server_id,map_id,device_id,begin_time,end_time,status,probe,reason FROM event WHERE event_id=$event_id";
